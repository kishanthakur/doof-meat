...
function ProductCard() {
  return (
    <div className="relative mt-8 flex w-full max-w-[260px] flex-col  rounded-lg border border-gray-100 bg-white shadow-md">
      <a className="relative mx-3 mt-3 flex h-60 rounded-xl" href="#">
        <Image
          className="object-cover"
          src="/category-1-1.png"
          alt="product image"
          width={300}
          height={30}
        />
      ...
      <div className="mt-4 px-5 pb-5">
        ...
        <a
          href="#"
          className="flex items-center justify-center rounded-md bg-red-500 px-5 py-2.5 text-center text-sm font-bold text-white hover:bg-red-400"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
