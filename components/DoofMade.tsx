  ...
  return (
    <section className="bg-red-50 mb-24">
      <div className="flex flex-wrap flex-row px-3 py-20 justify-center items-start lg:ml-48 lg:mr-48">
        {/* Box 1 */}
        <div className="mt-12 mr-4 flex items-center w-[250px]  h-[230px] bg-white border border-gray-200 rounded-lg shadow ">
          <div className="p-5">
            <h5 className="mb-2 text-2xl text-center font-mono tracking-tight text-gray-900">
              FSSAI Approved
            </h5>
          </div>
        </div>
        ...
        <div className="mt-12 mr-4 flex items-center w-[250px]   h-[230px] bg-white border border-gray-200 rounded-lg shadow ">
          <div className="p-5">
            <h5 className="mb-2 text-2xl text-center font-mono tracking-tight text-gray-900">
              Special organised Delivery channel (Doof Delivery) only for our
              Meats.
            </h5>
          </div>
        </div>
